...
#                    .format(thread, genome, tmp_file_location, name),
#                    shell=True, stdout=False)
...
#                    shell=True)
    ...
    print('tophat2 -p {} -I 1 -o {} {} {}'
                    .format(thread, tophat_result, tmp_file_location+'/'+genome_name+'.fa', cleanreads))
    
    subprocess.call('tophat2 -p {} -I 10 -o {} {} {}'
                    .format(thread, tophat_result, tmp_file_location+'/'+genome_name+'.fa', cleanreads), shell=True)
...
#    make_index(thread, genome, ribosome, tmp_file_location, genome_fasta, name)
    ...
    subprocess.call('samtools merge {} {}'.format(tmp_file_location+'/all_bam/total.bam',tmp_file_location+'/all_bam/*_accepted_hits.bam'), shell=True)
    subprocess.call(
